        ...
        <div class="row justify-content-center">
            <div class="col-lg-7 col-md-9">
                ...
                <div class="d-flex align-items-center gap-3 mb-4">
                    ...
                    {{-- Título --}}
                    <div>
                        <h1 class="fw-bolder text-warning mb-0">Editar Categoria</h1>
                        <p class="text-muted fs-6 mb-0">Modifique os dados da categoria <span class="fw-bold">{{ $category->nome }}</span>.</p>
                    </div>
                </div>
