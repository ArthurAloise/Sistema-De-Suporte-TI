...
@section('content')
  <h2 style="margin:0 0 12px 0;color:#111;font-size:20px;">Chamado resolvido ✅</h2>
  ...
  <p style="margin:0 0 12px 0;color:#222;font-size:15px;">Descrição da resolução:<br>{!! nl2br(e($chamado->descricao_resolucao)) !!}</p>
  <p style="margin:0 0 16px 0;">
    <span style="display:inline-block;background:#28a745;color:#fff;border-radius:12px;padding:4px 10px;font-size:12px;font-weight:700;">
      Status: Resolvido
    </span>
  </p>
  <p>
